            ...
            <div class="card-header d-flex justify-content-between align-items-center">
              <div class="card-header-title">Daftar Posting</div>
                <div class="justify-content-end m-0 p-0">
                    <a  class="btn btn-sm btn-labeled-right btn-success" data-bs-toggle="modal" data-bs-target="#ModalPosts">
              ...
              <table class="table table-actions table-striped table-hover mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('managepost.destroy', ["id" => $w->id ]) }}" class="btn btn-sm btn-danger">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
