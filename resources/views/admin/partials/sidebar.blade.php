    ...
    <ul class="sidebar-nav">
      ...
      <li class="sidebar-nav-item">
        ...
        <ul class="sidebar-sub-nav collapse" id="navForms">
          <li class="sidebar-nav-item">
            <a href="{{ route('daftarwarga.index') }}" class="sidebar-nav-link">
              <span class="sidebar-nav-abbr">
                Mw
              </span>
              <span class="sidebar-nav-name">
      ...
      <li class="sidebar-nav-item">
        <a class="sidebar-nav-link collapsed" data-toggle="collapse" href="#navTables2" aria-expanded="false" aria-controls="navTables2">
          <span class="sidebar-nav-icon">
        ...
        <ul class="sidebar-sub-nav collapse" id="navTables2">
          <li class="sidebar-nav-item">
            <a href="{{ route('manage-admin.index') }}" class="sidebar-nav-link">
              <span class="sidebar-nav-abbr">
                Ma
              </span>
              <span class="sidebar-nav-name">
