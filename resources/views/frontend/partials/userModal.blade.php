                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <form method="POST" action="{{ route('managepost.update') }}">
                                                    @csrf
                                    ...
                                    {{-- <div class="container">
                                        <div class="row">
                                            <div class="col-lg-12 text-center">
                                                ...
                                                @if(request('punya-kos', '0')=='0')
                                                    <h1>Update Profile Penyewa Kos</h1>
                                                @else
                                                    <h1>Update Profile Pemilik Kos</h1>
                                                @endif
                                                <hr style="border: 0.5px solid #F86D08;">
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <form method="POST" action="{{ route('managepost.update') }}">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="noTelp" class="form-label">No Telp</label>
                                                        <input id="noTelp" type="number" class="form-control @error('noTelp') is-invalid @enderror"
                                                            name="noTelp" value="{{ $user->noTelp }}" required autocomplete="noTelp" autofocus>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="tanggalLahir" type="date"
                                                            ...
                                                            value="{{ $user->tanggalLahir }}" required autocomplete="tanggalLahir">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="alamat" class="form-label">Alamat</label>
                                                        <textarea id="alamat" type="Text" class="form-control" name="alamat">{{ $user->alamat }}</textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="email" class="form-label">Email</label>
