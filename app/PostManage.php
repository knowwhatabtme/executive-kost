...
class PostManage extends Model
{
    ...
    protected $fillable = [ 'nik_user', 'namaKos', 'desc','region' , 'jenisKos', 'jumLantai', 'jumKamar', 'jumKamarMandi', 'address', 'jalurTransport', 'fasilitas_kamar', 'fasilitas_sekitar', 'maps', 'harga', 'picture', 'published_at' ];
